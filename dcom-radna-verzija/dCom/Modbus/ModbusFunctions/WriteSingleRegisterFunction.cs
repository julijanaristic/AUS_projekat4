...
namespace Modbus.ModbusFunctions
{
    ...
    public class WriteSingleRegisterFunction : ModbusFunction
    {
        ...
        public override byte[] PackRequest()
        {
            ...
            Buffer.BlockCopy((Array)BitConverter.GetBytes(IPAddress.HostToNetworkOrder((short)paramCom.OutputAddress)), 0, (Array)request, 8, 2);
            Buffer.BlockCopy((Array)BitConverter.GetBytes(IPAddress.HostToNetworkOrder((short)paramCom.Value)), 0, (Array)request, 10, 2);
        ...
        public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
        {
            ...
            ushort address = BitConverter.ToUInt16(new byte[2] { tempAdress[1], tempAdress[0] }, 0);
